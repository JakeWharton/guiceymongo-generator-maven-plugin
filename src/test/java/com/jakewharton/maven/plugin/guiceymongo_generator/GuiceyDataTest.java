...
public class GuiceyDataTest extends AbstractMojoTestCase {
	 ...
	 * 
	 * <p>Any other testing is really beyond the scope of this plugin. Testing of
	 * the actual GuiceyData generator should be encapsulated in its library.</p>
	 */
	@Test
	public void testGeneratedFile() {
		...
		GuiceyDataMojo myMojo = null;
		try {
			myMojo = (GuiceyDataMojo)this.lookupMojo(GuiceyDataTest.POM_GOAL, pom);
		} catch (Exception e1) {
			e1.printStackTrace();
			Assert.fail();
		}
